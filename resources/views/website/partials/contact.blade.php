 <section class="contact-one">
            <div class="contact-one__bg jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% -100%"
                style="background-image: url(assets/images/backgrounds/contact-bg-1.jpg);"></div>
            <!-- /.video-one__shape -->
            <div class="contact-one__shape"
                style="background-image: url(assets/images/shapes/contact-1-shape-2.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-5">
                        <div class="contact-one__image">
                            ...
                            <div class="contact-one__image__icon"><img src="assets/images/shapes/icon-1.png"
                                    alt="careox"></div>
                            <div class="contact-one__image__info">
                                ...
                                <p class="contact-one__image__info__text"><a href="tel:++25844132">++(25)844132</a>
                                </p>
                            </div>
                        </div>
                    </div><!-- /.col-xl-5 -->
                    <div class="col-xl-7">
                        <form class="contact-one__form contact-form-validated form-one wow fadeInUp"
                            ...
                            <div class="sec-title text-left">
                                ...
                                <h3 class="sec-title__title bw-split-in-left">Our Volunteer Become Us <br>This Contact
                                    Now!</h3><!-- /.sec-title__title -->
                            </div><!-- /.sec-title -->
