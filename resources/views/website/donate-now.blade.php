...
@section('content')
    ...
    <section class="page-header">
        ...
        <!-- /.page-header__bg -->
        <div class="container">
            <h2 class="page-header__title bw-split-in-left">Donate Now</h2>
    ...
    <section class="donate-two" style="padding-top: 100px;">
        <div class="container">
            <div class="sec-title text-center">
                ...
                <h3 class="sec-title__title bw-split-in-left">Become a Donate Now</h3>
            </div><!-- /.sec-title -->
            @php
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="donate-two__content">
                            ...
                            <form action="{{route("front.donate.now")}}" class="donate-two__form">
                                <div class="donate-two__form__amount">
                                    <span class="donate-two__form__amount__sign">£</span>
                                    <input type="text" value="{{ $donationForm->amounts->first()->amount }}"
