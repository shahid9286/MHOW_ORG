...
@section('content')
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="about-contact-grid">
                        ...
                        <div class="about-contact-details align-self-center">
                            ...
                            <p class="about-contact-details-text"><a href="tel:{{ $setting->phone_no }}">{{ $setting->phone_no }}</a></p>
                            @if ($setting->phone_no_2)
                                <p class="about-contact-details-text"><a href="tel:{{ $setting->phone_no_2 }}">{{ $setting->phone_no_2 }}</a></p>
                            @endif
                        </div>
                    </div>
                </div>
    ...
    @include('hijrah.partials.contact-us.contact-us-form')
...
@section('js')
    ...
    @include('hijrah.partials.contact-us.contact-us-script')
