    ...
    <div class="container">
        <div class="row gy-4 gx-4">
            <div class="title-area text-center mb-0">
                ...
                <h3 class="sec-title mb-3">Building a Better World Together</h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="destination-item th-ani">
                        ...
                        <div class="destination-content"
                            ...
                            <h3 class="box-title mb-2 text-white"><a href="{{ route('front.project.detail', ['slug' => $project->slug]) }}">{{ $project->name }}</a></h3>
                            <a href="{{ route('front.project.detail', ['slug' => $project->slug]) }}" class="th-btn th-icon" style="background-color: #A91F21;">Detail</a>
                        </div>
                    </div>
                </div>
            @endforeach
