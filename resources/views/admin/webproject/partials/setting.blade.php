        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card" style="position: relative; left: 0px; top: 0px;">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form id="sortForm" method="POST" action="{{ route('admin.course.setting.update', $slug) }}">
                            @csrf
                            <ul class="todo-list ui-sortable" id="sortable" data-widget="todo-list">
                                @php
                                    $colors = [
                                        'App\\Models\\CourseSection' => 'badge-primary',
                                        'App\\Models\\CourseBlock' => 'badge-success',
                                        'App\\Models\\CourseCTA' => 'badge-warning',
                                        'App\\Models\\CourseElement' => 'badge-info',
                                        'App\\Models\\CourseWhyChooseUs' => 'bg-purple',
                                        'App\\Models\\CourseOutline' => 'bg-pink',
                                        'App\\Models\\CourseFeature' => 'bg-orange text-white',
                                    ];
                                @endphp

                                @forelse ($course_sections as $setting)
                                    @php
