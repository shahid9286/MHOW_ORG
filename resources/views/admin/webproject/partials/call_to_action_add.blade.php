        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.course.cta.store', ['slug' => $slug]) }}" method="post"
                            ...
                            <div class="row mt-2">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input required type="text" class="form-control form-control-sm"
                                            id="button_text_1" placeholder="Enter Button Name" name="button_text_1">
                                    </div>
                                    @error('button_text_1')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input required type="url" class="form-control form-control-sm"
                                            id="ctaButtonLink_1" placeholder="Enter Button URL" name="button_link_1">
                                    </div>
                                    @error('button_link_1')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="Enter Button Name" id="button_text_2"
                                            name="button_text_2">
                                    </div>
                                    @error('button_text_2')
                                        <p class="text-danger">{{ $message }}</p>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="url" class="form-control form-control-sm" placeholder="Enter Button URL" id="ctaButtonLink_2"
                                            name="button_link_2">
                                    </div>
                                    @error('button_link_2')
                                        <p class="text-danger">{{ $message }}</p>
