                ...
                <div class="card card-primary card-outline mt-2">
                    <div class="card-header">
                        ...
                        <div class="card-tools d-flex">
                            <a href="{{ route('admin.blog.section.add', ['slug' => $slug]) }}" class="btn btn-primary btn-sm">
                                ...
                                @foreach ($sections as $section)
                                    <tr>
                                       ...
                                       <td><img src="{{ asset($section->image) }}" alt="Image" width="50px"></td>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.blog.section.edit', $section->id) }}"
                                                class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>

                                            <form id="deleteform" class="d-inline-block mx-1"
                                                action="{{ route('admin.blog.section.delete', $section->id) }}"
                                                method="post">
                                                @csrf
