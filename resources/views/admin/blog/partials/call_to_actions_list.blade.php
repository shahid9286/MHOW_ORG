                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('admin.blog.cta.add', ['slug' => $slug]) }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg"></i> Add Call To Action</a>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($ctas as $key => $callToAction)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.blog.cta.edit', $callToAction->id) }}" class="btn btn-sm btn-primary"><i class="bi bi-pencil"></i> </a>
                                                <form id="deleteform" class="d-inline-block"
                                                    action="{{ route('admin.blog.cta.delete', $callToAction->id) }}"
                                                    method="post">
                                                    @csrf
