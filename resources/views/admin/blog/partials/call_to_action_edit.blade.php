        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.blog.cta.update', ['id' => $cta->id]) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input required type="text" class="form-control form-control-sm" id="ctaTitle"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="ctaSubtitle"
