                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card card-primary card-outline mt-3">
                            ...
                            <form class="form-horizontal" action="{{ route('admin.email-templates.store') }}"
                                method="POST">
                                @csrf
                                <div class="card-body">
                                    {{-- Title --}}
                                    <div class="form-group">
                                        <label for="title">{{ __('Template Title') }} <span
                                    ...
                                    {{-- Subject --}}
                                    <div class="form-group">
                                        <label for="subject">{{ __('Email Subject') }} <span
                                                class="text-danger">*</span></label>
                                    ...
                                    {{-- Body --}}
                                    <div class="form-group">
                                        <label for="body">{{ __('Email Body') }} <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="card-footer text-right">
                                    <button type="submit"
                                        class="btn btn-sm btn-primary">{{ __('Save Email Template') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
