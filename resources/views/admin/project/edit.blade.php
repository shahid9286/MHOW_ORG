...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <form class="form-horizontal" action="{{ route('admin.project.update', $project->id) }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline mt-2">
                            <div class="card-header">
                                <h3 class="card-title mt-1"> <b> {{ __('Edit Project') }} </b> </h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="description" class="summernote form-control form-control-sm" name="description"
                                            placeholder="{{ __('Enter Project Description') }}">{{ old('description', $project->description) }}</textarea>
                                    ...
                                    <!-- Amount -->
                                    <div class="col-md-6">
                                        <label for="target_amount">{{ __('Amount') }} <span
                                                class="text-danger">*</span></label>
                                        ...
                                        <select id="donation_form_id" name="donation_form_id"
                                            ...
                                            @foreach ($donation_forms as $donation_form)
                                                <option value="{{ $donation_form->id }}"
                                                    {{ $project->donation_form_id == $donation_form->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input required type="text" class="form-control form-control-sm"
                                            id="update_whyus_icon" name="icon"
            ...
            <div class="col-12">
                <button type="submit"
                    class="btn btn-sm mb-1 btn-primary float-right">{{ __('Update Project') }}</button>
            </div>
            </form>
        </div>
        </div>
