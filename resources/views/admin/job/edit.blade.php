                    ...
                    <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.job.update',$job->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="serial_number" class="col-sm-2 control-label">{{ __('Order') }}</label>
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="serial_number" placeholder="{{ __('Order No') }}" value="{{ old('serial_number', $job->serial_number) }}">
