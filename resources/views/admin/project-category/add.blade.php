...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <form class="form-horizontal" action="{{ route('admin.project-category.store') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline mt-2">
                            <div class="card-header">
                                <h3 class="card-title mt-1"> <b> {{ __('Add Project Category') }} </b> </h3>
                            ...
                            <div class="card-body py-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-md-6">
                                        ...
                                        <input type="text" id="name" class="form-control form-control-sm"
                                            ...
                                            placeholder="{{ __('Enter Project Category Name') }}"
                                    ...
                                    <div class=" col-md-12 mt-3">
                                        ...
                                        <textarea id="description" class="summernote form-control form-control-sm" name="description"
                                            placeholder="{{ __('Enter Project Category Description') }}">{{ old('description') }}</textarea>
                                ...
                                <div class=" col-12">
                                    <button type="submit"
                                        class="btn btn-sm mb-1 btn-primary float-right">{{ __('Save New Project Category') }}</button>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
