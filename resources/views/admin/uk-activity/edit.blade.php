...
@section('title', 'Edit Uk Activities')
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ __('Edit Uk Activity') }} </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i
                                    class="fas fa-home"></i>{{ __('Home') }}</a></li>
                        <li class="breadcrumb-item">{{ __('Uk Activities') }}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Edit Uk Activity') }}</h3>
                            <div class="card-tools">
                                <a href="{{ route('admin.uk-activity.index') }}" class="btn btn-primary btn-sm">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.uk-activity.update', $uk_activity->id) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="city" class="form-control" name="city"
                                            value="{{ old('city', $uk_activity->city) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="events" class="form-control" name="events"
                                            value="{{ old('events', $uk_activity->events) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="locations" class="form-control" name="locations"
                                            value="{{ old('locations', $uk_activity->locations) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="people" class="form-control" name="people"
                                            value="{{ old('people', $uk_activity->people) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" id="order" class="form-control" name="order"
                                            value="{{ old('order', $uk_activity->order) }}"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <img class="mw-400 mb-3 show-img img-demo"
                                            src="{{ asset('assets/admin/uploads/uk-activity/' . $uk_activity->logo) }}"
                                            alt="" width="200px">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <select id="status" name="status" class="form-control"
                                            value="{{ old('status', $uk_activity->status) }}">

                                            <option value="active"
                                                {{ $uk_activity->status == 'active' ? 'selected' : '' }}>Active
                                            </option>
                                            <option value="inactive"
                                                {{ $uk_activity->status == 'inactive' ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
