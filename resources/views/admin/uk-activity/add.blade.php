...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ __('Add New Uk Activity') }} </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Add Uk Activity') }}</h3>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.uk-activity.store') }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="events" class="form-control" name="events"
                                            value="{{ old('events') }}" placeholder="{{ __('Enter Events') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="locations" class="form-control" name="locations"
                                            value="{{ old('locations') }}" placeholder="{{ __('Enter Location') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" id="people" class="form-control" name="people"
                                            value="{{ old('people') }}" placeholder="{{ __('Enter People') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" id="order" class="form-control" name="order"
                                            value="{{ old('order') }}" placeholder="{{ __('Enter Order Number') }}">
                                        @if ($errors->has('order'))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <img class="mw-400 mb-3 show-img img-demo"
                                            src="{{ asset('assets/admin/uploads/uk-activity/') }}" alt=""
                                            width="200px">
