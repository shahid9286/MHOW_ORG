                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="mw-400 mb-3 show-img img-demo" src="{{ asset('assets/front/img/gallery/'.$gallery->image) }}" alt="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="title" placeholder="{{ __('Title') }}" value="{{ $gallery->title }}">
                                            @if ($errors->has('title'))
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="category_id" id="gcategory_id">
                                                @foreach ($gcategories as $gcategory)
                                                    <option value="{{ $gcategory->id }}" {{ $gcategory->id == $gallery->category_id ? 'selected' : '' }} >{{ $gcategory->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="video_link" placeholder="{{ __('Video Link') }}" value="{{ $gallery->video_link }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="serial_number" placeholder="{{ __('Order') }}" value="{{ $gallery->serial_number }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="status">
                                                    <option value="0" {{ $gallery->status == '0' ? 'selected' : '' }}>{{ __('Unpublish') }}</option>
                                                    <option value="1" {{ $gallery->status == '1' ? 'selected' : '' }}>{{ __('Publish') }}</option>
                                            </select>
