...
@section('title', 'Add Global Activity')
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">{{ __('Add New Global Activity') }} </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ __('Add Global Activity') }}</h3>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('admin.global-activity.store') }}" method="post"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <img class="mw-400 mb-3 show-img img-demo"
                                            src="{{ asset('assets/admin/uploads/global-activity/') }}" alt=""
                                            width="200px">
