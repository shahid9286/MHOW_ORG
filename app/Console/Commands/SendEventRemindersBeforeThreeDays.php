...
class SendEventRemindersBeforeThreeDays extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'events:remind-3days';
    protected $description = 'Send email reminders 3 days before event date';
    ...
    public function handle()
    {
        ...
        foreach ($events as $event) {
            ...
            $schedule = EventSchedule::where('event_id', $event->id)->first();
